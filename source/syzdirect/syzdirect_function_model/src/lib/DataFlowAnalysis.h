...
class DataFlowAnalysis {
	...
	public:
		...
		void findUseswithTrackLoad(Instruction *BorderInsn, Value *Target,
                                   set<use_t> &UseSet, set<Value *> &Visited, bool trackLoad);
		
		void findUseswithTrackLoad(Instruction *BorderInsn, Value *Target, set<Value*> &aliasSet, 
        ...
        void findSimpleUses(Instruction *BorderInsn, Value *Target,
                                    set<use_t> &UseSet,set<Value *> &Visited);
		...
		void findInFuncSourceCV(Value *V, set<Value *> &SourceSet, 
				set<Value *> &CVSet, set<Value *> &TrackedSet,bool traceAlias=true);
